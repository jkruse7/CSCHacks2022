...
//    var user: User?
    override func viewDidLoad() {
        super.viewDidLoad()
//        validateAuth()
        numRoomates.frame = CGRect(x: 26, y: SecondPref.bottom + 50, width: 350, height: 40)
        self.picker.delegate = self
        self.picker.dataSource = self
        self.picker.frame = CGRect(x: 26, y: numRoomates.bottom, width: 350, height: 60)
        pickerData = ["1", "2", "3", "4", "5", "6"]
        refArtists = Database.database().reference()
        
        bioString.frame = CGRect(x: 26, y: picker.bottom, width: 350, height: 40)
        bio.frame = CGRect(x: 26, y: bioString.bottom, width: 350, height: 40)
        
        habitString.frame = CGRect(x: 26, y: morning.bottom, width: 350, height: 40)
        habit.frame = CGRect(x: 26, y: habitString.bottom, width: 350, height: 40)
        
        partyString.frame = CGRect(x: 26, y: habit.bottom, width: 350, height: 40)
        party.frame = CGRect(x: 26, y: partyString.bottom, width: 350, height: 40)
        
        dealString.frame = CGRect(x: 26, y: party.bottom, width: 350, height: 40)
        deal.frame = CGRect(x: 26, y: dealString.bottom, width: 350, height: 40)
        
        tempString.frame = CGRect(x: 26, y: deal.bottom, width: 350, height: 40)
        temp.frame = CGRect(x: 26, y: tempString.bottom, width: 350, height: 40)
        
        homeString.frame = CGRect(x: 26, y: temp.bottom, width: 350, height: 40)
        home.frame = CGRect(x: 26, y: homeString.bottom, width: 350, height: 40)
    }
    ...
    func configureTapMeButton(){
        yearString.frame = CGRect(x: 26, y: 75, width: 350, height: 40)
        tapMeButton.layer.borderColor = UIColor.lightGray.cgColor
        tapMeButton.layer.borderWidth = 2
        tapMeButton.layer.cornerRadius = 12
        tapMeButton.frame = (CGRect(x: 26, y: yearString.bottom, width: 350, height: 40))
    ...
    func configureFirstPrefButton(){
        topTwoString.frame = CGRect(x: 26, y: tapMeButton.bottom, width: 350, height: 40)
        firstPrefString.frame = CGRect(x: 26, y: topTwoString.bottom, width: 350, height: 40)
        FirstPref.layer.borderColor = UIColor.lightGray.cgColor
        FirstPref.layer.borderWidth = 2
        FirstPref.layer.cornerRadius = 12
        FirstPref.frame = (CGRect(x: 32, y: firstPrefString.bottom, width: 350, height: 40))
    ...
    func configureSecondPrefButton(){
        secondPrefString.frame = CGRect(x: 26, y: FirstPref.bottom, width: 350, height: 40)
        SecondPref.layer.borderColor = UIColor.lightGray.cgColor
        SecondPref.layer.borderWidth = 2
        SecondPref.layer.cornerRadius = 12
        SecondPref.frame = (CGRect(x: 32, y: secondPrefString.bottom, width: 350, height: 40))
    ...
    func configureGenderButton(){
        genderString.frame = CGRect(x: 26, y: bio.bottom, width: 350, height: 40)
        gender.layer.borderColor = UIColor.lightGray.cgColor
        gender.layer.borderWidth = 2
        gender.layer.cornerRadius = 12
        gender.frame = (CGRect(x: 31, y: genderString.bottom, width: 350, height: 40))
    }
    ...
    func configurePersonButton(){
        morningString.frame = CGRect(x: 26, y: clean.bottom, width: 350, height: 40)
        morning.layer.borderColor = UIColor.lightGray.cgColor
        morning.layer.borderWidth = 2
        morning.layer.cornerRadius = 12
        morning.frame = (CGRect(x: 31, y: morningString.bottom, width: 350, height: 60))
    ...
    func configureDrugsButton(){
        drugsString.frame = CGRect(x: 26, y: guest.bottom, width: 350, height: 40)
        drugs.layer.borderColor = UIColor.lightGray.cgColor
        drugs.layer.borderWidth = 2
        drugs.layer.cornerRadius = 12
        drugs.frame = (CGRect(x: 31, y: drugsString.bottom, width: 350, height: 40))
    }
    ...
    func configureCleanButton(){
        cleanString.frame = CGRect(x: 26, y: gender.bottom, width: 350, height: 40)
        clean.layer.borderColor = UIColor.lightGray.cgColor
        clean.layer.borderWidth = 2
        clean.layer.cornerRadius = 12
        clean.frame = (CGRect(x: 29, y: cleanString.bottom, width: 350, height: 40))
    ...
    func configureGuestsButton(){
        guestString.frame = CGRect(x: 26, y: home.bottom, width: 350, height: 40)
    ...
    func configureGuestsButtonMenu() {
        ...
        guest.menu = menu
        guest.frame = (CGRect(x: 29, y: guestString.bottom, width: 350, height: 40))
    }
